        ...
        <table className="w-full table-fixed text-sm">
          <thead>
            <tr className="text-xs text-gray-400">
              ...
              <th className="w-16 px-2 py-2 text-right font-medium">Clicks</th>
              <th className="w-20 px-2 py-2 text-right font-medium">Impr.</th>
              <th className="w-14 px-4 py-2 text-right font-medium">Pos.</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r) => (
