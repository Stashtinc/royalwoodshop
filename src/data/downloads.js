export const downloads = [
  {
    ...
    title: ‘Royal Woodworking Product Catalogue’,
    description:
    ...
    format: ‘PDF’,
    href: ‘/downloads/royal-woodworking-brochure.pdf’,
  },
  {
    ...
    format: ‘PDF’,
    href: ‘/downloads/alexandria-east-product-catalogue.pdf’,
  },
  {
    slug: ‘2026-trimlite-interior-brochure’,
    title: ‘Trimlite 2026 Interior Door Brochure’,
    description:
      ‘The full 2026 Trimlite interior door collection — styles, glass options, and finishing details for stain-grade and primed lines.’,
    format: ‘PDF’,
    href: ‘/downloads/2026-trimlite-interior-brochure.pdf’,
  },
]
